...
import { createCompany, getCompanyById, getUserCompany, UpdateCompanyById } from '../../api/CompanyApi';
...
function EditCompany() {
  ...
  const getDetails=async()=>{
    ...
    if(res.success){
      ...
      const {c_name,c_desc,c_website,c_phone,c_location,c_email} = res.data;
     
      setinitialValues({c_name,c_desc,c_website,c_phone,c_address:c_location.formattedAddress,c_email})
      setshowForm(true)
