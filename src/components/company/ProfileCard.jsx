...
theme="light"  />
   ...
   <h1 className='font-Poppins text-sm text-gray-500 flex justify-start items-center   my-2 text-left'><i class='mr-2 bx bx-current-location'></i><span className=''>{company?.c_location.formattedAddress}</span></h1>
            ...
            <div className="flex my-5 w-full justify-between items-center">
              <div className="col mt-[-30px] pr-2">
            ...
            <button type="button" class="shadow-md border-2  font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center mr-2 text-redlight bg-reddark">
